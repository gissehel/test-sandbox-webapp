    ...
    @testlib =
        page :
            ...
            init : () ->
                ...
                @$newtag_close = @builder.mkobj 'newtag-close', parent: @$newtagzone, outter: true, text: '\u25b6', classes : ['newitem-close','close','icon']
                ...
                @$newinfo_close = @builder.mkobj 'newinfo-close', parent: @$newinfozone, outter: true, text: '\u25b6', classes : ['newitem-close','close','icon']
            ...
            create_info : (args) ->
                ...
                $info_fold = @builder.mkobj 'info-fold', parent: $info, outter: true, text: '\u25b2', classes : ['item-fold','fold','icon']
                $info_unfold = @builder.mkobj 'info-unfold', parent: $info, outter: true, text: '\u25bc', classes : ['item-unfold','unfold','icon']
                $info_close = @builder.mkobj 'info-close', parent: $info, outter: true, text: '\u2716', classes : ['item-close','close','icon']
